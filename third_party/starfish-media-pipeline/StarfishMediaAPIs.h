...
public:
    ...
    bool Load(const char*, void(*)(int, int64_t, const char*)) { return true; }
    bool Load(const char*, void(*)(int, int64_t, const char*, void*), void*) { return true; }
    bool Play() { return true; }
    bool Pause() { return true; }
    bool Stop() { return true; }
    bool Unload() { return true; }
    bool Seek(const char*) { return true; }
    bool setVolume(const char*) { return true; }
    bool setWindowId(const char*) { return true; }
    bool SetPlayRate(const char*) { return true; }
    bool SetProperty(const char*) { return true; }
    bool notifyForeground() { return true; }
    bool notifyBackground() { return true; }
    int64_t getCurrentPlaytime() { return 0; }
